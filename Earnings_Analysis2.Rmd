...
#pholders <- read.csv("https://drive.google.com/file/d/1eA0vtYoXUa7ODtbLI066DNNZl9v9MEcu/view?usp=sharing", stringsAsFactors = FALSE)
#pholders <- read.csv("E:/GoogleDrive/CURRENT_PROJECTS/3_SASAP_salmon_synthesis/Analysis_ref_files/CFEC_Permits_1975-2016.csv",stringsAsFactors = FALSE)
#adding SASAPRegions
#regions <- read.csv("https://drive.google.com/file/d/1setidHN984d8N-m7PTGWK4a75rxPYswZ/view?usp=sharing", stringsAsFactors=FALSE)

pholders <- `CFEC_Permits_1975.2016.(3)`%>%
  mutate_if(is.factor, as.character)

regions <- read.csv("E:/GoogleDrive/CURRENT_PROJECTS/3_SASAP_salmon_synthesis/Analysis_ref_files/index_table_041918.csv", stringsAsFactors = FALSE)
...
f <- read.csv("E:/GoogleDrive/CURRENT_PROJECTS/3_SASAP_salmon_synthesis/Analysis_ref_files/fishery_codes_regions.csv", stringsAsFactors=FALSE)
f <- f[,1:2]
...
#FT <- read.csv("https://drive.google.com/file/d/1h0TWifG-8hHsTNyn3KNdPZHmL9fvOtBZ/view?usp=sharing", stringsAsFactors = FALSE)
...
index_table_EarningsFlow <- read.csv("E:/GoogleDrive/CURRENT_PROJECTS/3_SASAP_salmon_synthesis/Analysis_ref_files/index_table_EarningsFlow.csv", stringsAsFactors=FALSE)
...
cpi <- read.csv("E:/GoogleDrive/CURRENT_PROJECTS/3_SASAP_salmon_synthesis/Analysis_ref_files/CPI_US_ANC.csv", stringsAsFactors=FALSE)
